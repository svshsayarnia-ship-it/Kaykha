...
<link rel="preload" href="/kaykha-online.js?v=20260920freeze1" as="script" fetchpriority="high">
...
function enterCity(name){
    ...
    enterCity.timer=setTimeout(()=>{showCity(name);stage?.classList.remove('is-transitioning')},850);
  }
